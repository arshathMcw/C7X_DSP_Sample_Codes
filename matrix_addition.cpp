...
void matrix_add_scalar(int row,int col,int16_t *aIdx,int16_t *bIdx,int16_t *rIdx,int &iteration){
...
int main(){
    ...
    matrix_add_scalar(row,col,mat1Idx,mat2Idx,resIdx,iteration1);
    matrix_add_optimized(row,col,mat1Idx,mat2Idx,res2Idx,iteration2);
