...
#include "utils.h"
void matrix_add_optimized(int row,int col,int depth,int16_t *aIdx,int16_t *bIdx,int16_t *rIdx,int &iteration){
...
void matrix_add_scalar(int row,int col,int depth,int16_t *aIdx,int16_t *bIdx,int16_t *rIdx,int &iteration){
...
int main(){
    ...
    matrix_add_scalar(row,col,depth,mat1Idx,mat2Idx,resIdx,iteration1);
    matrix_add_optimized(row,col,depth,mat1Idx,mat2Idx,res2Idx,iteration2);
